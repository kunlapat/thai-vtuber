...
export default function LiveVideoCard({ video, variant = 'grid' }: LiveVideoCardProps) {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200 h-full group">
      <div className="flex flex-col h-full">
        ...
        >
          ...
          />
          {/* Live badge */}
          <div className={`absolute top-2 left-2 px-1.5 py-0.5 rounded text-[11px] font-medium flex items-center gap-1 ${
            isLive
              ? 'bg-red-600 text-white'
              : 'bg-gray-600 text-white'
          }`}>
